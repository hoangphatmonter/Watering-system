...
public class MQTTService {
    ...
    final String clientId ="giotto";
    final String subscriptionTopic ="giottopham/feeds/bbc-led";
    final String username ="giottopham";
    final String password ="aio_qleG75bc1GTL4JP9RTFEzx32tKXi";
